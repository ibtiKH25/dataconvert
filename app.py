...
Let's focus on creating and managing the DataFrame that will be used to store and process the extracted data. We will ensure the DataFrame is created properly and that it includes the necessary fields, including 'Pigtail' and 'HV'.

Steps to Create and Manage the DataFrame
Extract Data from the Image: Use YOLO and Tesseract to extract data from the image.
Create a DataFrame: Store the extracted data in a pandas DataFrame.
Add Default Columns: Add default columns like 'Pigtail' and 'HV'.
Save and Display Data: Save the DataFrame to MongoDB and provide options to download it as a CSV.
Here’s the full code for your Streamlit app:
